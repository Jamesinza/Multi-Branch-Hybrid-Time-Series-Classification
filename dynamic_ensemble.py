...
def create_random_model(seed, data):
    ...
    return model, train_ds, val_ds, test_ds, train_steps, val_steps, test_steps, y_train
...
for i, seed in enumerate(seeds):
    model, train_ds, val_ds, test_ds, train_steps, val_steps, test_steps, y_train = create_random_model(seed, data)
...
# def ensemble_predict_weighted(models, weights, test_ds):
#     for X,y in test_ds:
